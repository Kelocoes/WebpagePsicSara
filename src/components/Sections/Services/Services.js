                    ...
                    <Grid container spacing={3} justifyContent="center" sx={{ padding: 1 }}>
                        <Grid item sm={12} md={6} lg={3}>
                            <Grow in={order.length >= 1} timeout={1000}>
                                <Box align="center" sx={{ backgroundColor: '#aa86d3', padding: 2, borderRadius: 3, border: 3, borderColor: '#A381CA' }}>
                                    <Typography sx={{ fontSize: 30, textShadow: '2px 2px 2px rgba(0, 0, 0, 0.2)' }}>Psicoterapia <br /> individual</Typography>
                                    <PsychologyAltIcon sx={{ fontSize: 75 }} />
                                    <Typography sx={{ fontSize: 18, textAlign: "justify", paddingX: 2, paddingTop: 1 }}> 
                                        Mi servicio de psicoterapia está diseñado para ayudarte a sentirte mejor emocional, mental y psicológicamente. <br />
                                        ¿Mi secreto? Un enfoque basado en la terapia humanista centrada en la persona. Esto significa que nuestras sesiones
                                        son personalizadas y se adaptan a tus necesidades, sin juicios, etiquetas ni restricciones.  <br />
                        ...
                        <Grid item sm={12} md={6} lg={3}>
                            <Grow in={order.length >= 2} timeout={1000}>
                                <Box align="center" sx={{ backgroundColor: '#aa86d3', padding: 2, borderRadius: 3, border: 3, borderColor: '#A381CA'}}>
                                    <Typography sx={{ fontSize: 30, textShadow: '2px 2px 2px rgba(0, 0, 0, 0.2)' }}>Orientación <br /> vocacional</Typography>
                        ...
                        <Grid item sm={12} md={6} lg={3}>
                            <Grow in={order.length >= 3} timeout={1000}>
                                <Box align="center" sx={{ backgroundColor: '#aa86d3', padding: 2, borderRadius: 3, border: 3, borderColor: '#A381CA'}}>
                                    <Typography sx={{ fontSize: 30, textShadow: '2px 2px 2px rgba(0, 0, 0, 0.2)' }}>Escuela <br /> para padres</Typography>
                        ...
                        <Grid item sm={12} md={6} lg={3}>
                            <Grow in={order.length >= 4} timeout={1000}>
                                <Box align="center" sx={{ backgroundColor: '#aa86d3', padding: 2, borderRadius: 3, border: 3, borderColor: '#A381CA'}}>
                                    <Typography sx={{ fontSize: 30, textShadow: '2px 2px 2px rgba(0, 0, 0, 0.2)' }}>Capacitación <br /> empresarial</Typography>
